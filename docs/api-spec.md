...
ดูรายละเอียดการตั้งค่า OAuth, token, sync และ webhook ใน
`docs/marketplace-api-integration.md`

```text
GET    /api/integrations/status
GET    /api/integrations/{channel}/authorize
GET    /api/integrations/{channel}/callback
POST   /api/integrations/{channel}/sync
POST   /api/integrations/{channel}/webhook
